...
var scalar_1 = require("../../../../../prisma-datamodel/dist/datamodel/scalar");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, databases.map(function (x) { return x.name; }).filter(function (x) { return reservedSchemas.indexOf(x) < 0; })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        collections = (_a.sent());
                        return [2 /*return*/, collections.map(function (collection) { return { name: collection.collectionName, collection: collection }; })];
                }
            });
        });
    };
    ...
    MongoConnector.prototype.inferType = function (value) {
        ...
        if (suggestion.type === documentConnector_1.ObjectTypeIdentifier) {
            ...
            if (value instanceof BSON.ObjectID) {
                suggestion.type = scalar_1.TypeIdentifiers.id;
                ...
                suggestion.type = scalar_1.TypeIdentifiers.integer;
            }
                ...
                suggestion.type = scalar_1.TypeIdentifiers.long;
            }
