...
var RelationResolveContext = /** @class */ (function () {
    ...
    RelationResolveContext.prototype.hasError = function (obj) {
        return obj.comments !== undefined &&
            obj.comments.some(function (x) { return x.isError; });
    };
    /**
    ...
    RelationResolveContext.prototype.attemptResolve = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4, _a, e_5, _b, e_6, _c, e_7, _d, data_1, data_1_1, val, e_4_1, _e, _f, field, value, values, values_1, values_1_1, value_1, _g, _h, collection, e_7_1, e_6_1, e_5_1;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 9:
                        _j.trys.push([9, 29, 30, 31]);
                        _e = __values(this.type.fields), _f = _e.next();
                        _j.label = 10;
                    case 10:
                        if (!!_f.done) return [3 /*break*/, 28];
                        field = _f.value;
                        if (!!this.hasError(field)) return [3 /*break*/, 27];
                        if (!(typeof field.type === 'string')) return [3 /*break*/, 25];
                        if (!(field.relationName === modelSampler_1.ModelSampler.ErrorType)) return [3 /*break*/, 24];
                        if (!(data[field.name] !== undefined)) return [3 /*break*/, 24];
                        ...
                        _j.label = 11;
                    case 11:
                        _j.trys.push([11, 22, 23, 24]);
                        values_1 = __values(values), values_1_1 = values_1.next();
                        _j.label = 12;
                    case 12:
                        if (!!values_1_1.done) return [3 /*break*/, 21];
                    ...
                    case 25:
                        if (!(data[field.name] !== undefined)) return [3 /*break*/, 27];
                    ...
                    if (field.relationName === modelSampler_1.ModelSampler.ErrorType) {
                        ...
                        try {
                            for (var _b = __values(this_2.collections), _c = _b.next(); !_c.done; _c = _b.next()) {
                                ...
                                var ratio = score.misses + score.hits === 0 ? 0 : score.hits / (score.misses + score.hits);
